...
def get_client_profile(client_id: str, admin: Admin = Depends(get_current_admin), db: Session = Depends(get_db)):
    ...
    for o in orders:
        orders_out.append({
            ...
            "project_progress": o.project_progress,
            "progress_step_label": step_label_for(o.project_progress),
            "has_invoice": o.invoice is not None,
            "has_technical_form": o.technical_form is not None,
    ...
    technical_forms_out = [
        {"id": f.id, "order_id": f.order_id, "company_name": f.company_name, "submitted_at": f.submitted_at}
