...
| `EMAIL_FROM` | `Cyber Teck Q <notifications@cyberteckq.com>` — **doit utiliser un domaine vérifié dans Resend** (cyberteckq.com l'est déjà ; outlook.com ne le sera jamais), voir étape 6 |
| `EMAIL_REPLY_TO` | `cyberteckq@outlook.com` — les réponses des clients à tes emails automatiques arriveront ici |
| `ADMIN_NOTIFICATION_EMAIL` | `cyberteckq@outlook.com` (ou l'adresse où tu veux recevoir les notifications) |
...
| `INTERAC_EMAIL` | `cyberteckq@outlook.com` (adresse affichée au client pour le virement) |
