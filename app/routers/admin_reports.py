...
def revenue_by_month(
    ...
    """
    v9.12 : bucket l'argent RÉELLEMENT encaissé (paiements approuvés, nets des
    remboursements) par mois de confirmation — pas le total facturé par mois
    de création de facture, qui peut inclure un solde de 60% pas encore payé.
    """
    ...
    results = [
        {
            ...
            "total_revenue": get_collected_amount(db, client_id=r.id),
