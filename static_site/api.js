...
const Api = {
  ...
  createOrder: (product_type) => apiRequest('/api/orders', { method: 'POST', body: { product_type } }),
  ...
  submitTechnicalForm: (orderId, payload) => apiRequest(`/api/orders/${orderId}/technical-form`, { method: 'POST', body: payload }),
  getTechnicalForm: (orderId) => apiRequest(`/api/orders/${orderId}/technical-form`),

  // ---------- Contrat de maintenance ----------
  getMaintenanceContract: (orderId) => apiRequest(`/api/orders/${orderId}/maintenance-contract`),
  saveMaintenanceContractInfo: (orderId, payload) => apiRequest(`/api/orders/${orderId}/maintenance-contract`, { method: 'PUT', body: payload }),
  signMaintenanceContract: (orderId, payload) => apiRequest(`/api/orders/${orderId}/maintenance-contract/sign`, { method: 'POST', body: payload }),
  ...
  // ---------- Admin : paiements (validation Interac) ----------
