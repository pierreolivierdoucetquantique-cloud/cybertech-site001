...
def get_collected_amount(db: Session, order_id: str | None = None, client_id: str | None = None) -> float:
    """
    Somme des montants RÉELLEMENT encaissés (paiements approuvés, nets des
    remboursements) — utilisée pour la logique de facturation automatique ET
    pour les statistiques financières ("revenu encaissé", pas "revenu facturé").
    """
